...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=python,pytorch,tensorflow,sklearn,mysql,postgres,firebase,express,fastapi,django,nodejs,html,css,js,ts,react,nextjs,threejs,tailwind,bootstrap,vite,aws,azure,gcp,netlify,vercel,git,github,npm,vscode,bash,linux,cpp,java,discord" />
  </a>
</p>
